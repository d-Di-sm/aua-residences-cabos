...
export const UI = () => {
  ...
  return (
    <main className="ui-viewer select-none text-[#FFFEF7] text-xl pointer-events-none">
      {/* Navbar igual que HomePage: logo, menú (Home, Ecoantal, lq, Veloria), redes */}
      <motion.header
        className="header header--scrolled header--viewer fixed z-100"
        variants={{
          visible: {
            opacity: 1,
            y: 0,
      ...
      >
        <div className="header__logo">
          <div className="header__logo__inner">
            <img
              src="/logos/AUA_Logo_V.png"
              alt="AUA Logo"
              className={
                isMobile
        ...
        <div className="header__menu">
          <button
            ...
            className="header__menu__item !bg-transparent !border-0 cursor-pointer font-inherit"
          >
            Home
          </button>
          <a
            href="https://mx.linkedin.com/company/ecoantal"
            target="_blank"
      ...
      <motion.section
        ...
        className={`z-10 fixed right-[10%] top-0 bottom-0 w-[40%] flex flex-col justify-end
          ${isMobile ? "text-center px-4 pb-8" : "text-left p-6 md:p-8 md:pb-20"}
      ...
      >
        <motion.h2
          ...
          className="flex flex-col items-start text-[#2e3f3a]"
        >
          {/* SOHO RESIDENCES */}
          {/* <img
          ...
          <img
            src="/logos/AUA_Logo_V_Red.png"
            alt="AUA Logo"
            className={isMobile ? "h-24 w-auto" : "h-32 w-auto"}
          />
        ...
        <motion.p
          ...
          className={`text-[#2e3f3a] font-bold whitespace-pre-line ${isMobile ? "text-sm" : "text-base"}`}
        >
          {isMobile
            ? `A refined residential project shaped by design, privacy, and the natural rhythm of Los Cabos.`
            : `A thoughtfully designed residential project where architecture, landscape, and lifestyle come together to create a refined
            way of living in Los Cabos.`}
        </motion.p>
      ...
      >
        ...
        >
          <motion.button
            ...
            className={`text-sm font-bold border-2 transition-colors duration-500 px-4 py-1 mt-2 rounded-lg w-1/2 md:w-auto ${
          ...
          <motion.button
            ...
            className={`bg-transparent hover:bg-[#C6C1AE] text-sm font-bold text-[#FFFEF7] hover:text-[#2E3641] border-2 border-[#FFFEF7]  transition-colors duration-500 px-4 py-1 mt-2 rounded-lg w-1/2 md:w-auto ${
